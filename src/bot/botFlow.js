// src/bot/botFlow.js — Member 4 Final Master Version (Unified)
...
export async function handleMessage(userPhone, incomingText, sessionState) {
  ...
  switch (step) {
    ...
    case STEPS.LANGUAGE: {
      ...
      return {
        reply: STRINGS[lMap[text]].category,
        newSessionState: { step: STEPS.CATEGORY, lang: lMap[text], data: {} },
        reportPayload: null,
      };
    }
    ...
    case STEPS.CATEGORY: {
      ...
      return {
        ...
        newSessionState: {
          ...
          data: { category: CATEGORIES_EN[cIdx - 1] },
        },
        reportPayload: null,
      };
    }
    ...
    case STEPS.URGENCY: {
      ...
      return {
        ...
        newSessionState: {
          ...
          data: { ...data, urgencyCode: URGENCY_EN[uIdx - 1] },
        },
        reportPayload: null,
      };
    }
    ...
    case STEPS.LOCATION: {
      if (!text) {
        return { reply: s.invalidText, newSessionState: sessionState, reportPayload: null };
      }
      return {
        reply: s.description,
        newSessionState: {
          step: STEPS.DESCRIPTION, lang,
